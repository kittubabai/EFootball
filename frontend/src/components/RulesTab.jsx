  ...
  return (
    <div style={{ maxWidth: '880px', margin: '0 auto' }}>
      ...
      <div className="glass-card" style={{ 
        ...
        background: 'linear-gradient(135deg, rgba(255, 190, 11, 0.08), rgba(0, 255, 135, 0.06))',
        padding: '24px'
      }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px', flexWrap: 'wrap', gap: '10px' }}>
          <div>
            <h3 style={{ fontSize: '1.3rem', fontWeight: '900', color: 'var(--accent-gold)', display: 'flex', alignItems: 'center', gap: '8px' }}>
              <Trophy size={22} color="#ffbe0b" />
              Official Prize Money Distribution (₹3,200 Total Pool)
            </h3>
            <div style={{ fontSize: '0.84rem', color: 'var(--text-muted)' }}>
              32 Players × ₹100 Entry Fee = ₹3,200 Total Collection
            </div>
          </div>

          <span style={{ fontSize: '0.86rem', fontWeight: '800', background: 'rgba(255, 190, 11, 0.15)', color: 'var(--accent-gold)', padding: '4px 12px', borderRadius: '999px', border: '1px solid rgba(255, 190, 11, 0.3)' }}>
            ₹2,400 Player Cash Prizes + ₹800 Admin Fund
          </span>
        </div>

        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '12px', marginBottom: '16px' }}>
          <div style={{ background: 'rgba(0,0,0,0.4)', padding: '14px', borderRadius: '10px', border: '1px solid rgba(0, 229, 255, 0.3)' }}>
            <div style={{ fontSize: '0.78rem', color: 'var(--accent-cyan)', fontWeight: '800' }}>ROOM WINNERS (4 GROUPS)</div>
            <div style={{ fontSize: '1.25rem', fontWeight: '900', color: '#fff', margin: '4px 0' }}>₹300 Each</div>
            <div style={{ fontSize: '0.74rem', color: 'var(--text-muted)' }}>
              Instant ₹300 reward for winning Group A, B, C, or D (4 × ₹300 = ₹1,200).
            </div>
          </div>

          <div style={{ background: 'rgba(0,0,0,0.4)', padding: '14px', borderRadius: '10px', border: '1px solid rgba(255, 190, 11, 0.4)' }}>
            <div style={{ fontSize: '0.78rem', color: 'var(--accent-gold)', fontWeight: '800' }}>🥇 GRAND CHAMPION (1ST)</div>
            <div style={{ fontSize: '1.25rem', fontWeight: '900', color: 'var(--accent-gold)', margin: '4px 0' }}>₹500 (+₹300) = ₹800</div>
            <div style={{ fontSize: '0.74rem', color: 'var(--text-muted)' }}>
              Finals Winner bonus + Group Winner prize.
            </div>
          </div>

          <div style={{ background: 'rgba(0,0,0,0.4)', padding: '14px', borderRadius: '10px', border: '1px solid rgba(160, 179, 207, 0.3)' }}>
            <div style={{ fontSize: '0.78rem', color: '#a0b3cf', fontWeight: '800' }}>🥈 RUNNER-UP (2ND)</div>
            <div style={{ fontSize: '1.25rem', fontWeight: '900', color: '#fff', margin: '4px 0' }}>₹300 (+₹300) = ₹600</div>
            <div style={{ fontSize: '0.74rem', color: 'var(--text-muted)' }}>
              Finals Runner-up bonus + Group Winner prize.
            </div>
          </div>

          <div style={{ background: 'rgba(0,0,0,0.4)', padding: '14px', borderRadius: '10px', border: '1px solid rgba(255, 138, 0, 0.3)' }}>
            <div style={{ fontSize: '0.78rem', color: '#ff8a00', fontWeight: '800' }}>🥉 3RD POSITION</div>
            <div style={{ fontSize: '1.25rem', fontWeight: '900', color: '#fff', margin: '4px 0' }}>₹200 (+₹300) = ₹500</div>
            <div style={{ fontSize: '0.74rem', color: 'var(--text-muted)' }}>
              3rd Place Match bonus + Group Winner prize.
            </div>
          </div>

          <div style={{ background: 'rgba(0,0,0,0.4)', padding: '14px', borderRadius: '10px', border: '1px solid rgba(0, 255, 135, 0.4)' }}>
            <div style={{ fontSize: '0.78rem', color: 'var(--accent-green)', fontWeight: '800' }}>⚽ GOLDEN BOOT</div>
            <div style={{ fontSize: '1.25rem', fontWeight: '900', color: 'var(--accent-green)', margin: '4px 0' }}>₹200 Extra Cash</div>
            <div style={{ fontSize: '0.74rem', color: 'var(--text-muted)' }}>
              Most total goals scored across the entire tournament.
            </div>
          </div>

          <div style={{ background: 'rgba(0,0,0,0.4)', padding: '14px', borderRadius: '10px', border: '1px solid rgba(255, 255, 255, 0.1)' }}>
            <div style={{ fontSize: '0.78rem', color: 'var(--text-dim)', fontWeight: '800' }}>🛡️ ORGANIZER FUND</div>
            <div style={{ fontSize: '1.25rem', fontWeight: '900', color: 'var(--text-muted)', margin: '4px 0' }}>₹800</div>
            <div style={{ fontSize: '0.74rem', color: 'var(--text-dim)' }}>
              Hosting, custom room management, and operational expenses.
            </div>
          </div>
        </div>
      </div>
